...
class Tracking(object):
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = 'console', resume_id='', config=None):
        ...
        if 'tracking' in default_backend or 'wandb' in default_backend:
            ...
            if len(resume_id) > 0:
                wandb.init(project=project_name, name=experiment_name, resume="allow", id=resume_id, config=config)
